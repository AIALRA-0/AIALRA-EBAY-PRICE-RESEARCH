...
这份文件约束维护和运行 `$ebay-price-research` 的 Agent
...
- 只通过 `.agents/skills/ebay-price-research/scripts/runner.py` 运行 Skill
...
- 根目录验证脚本
- CI 工作流
- `.agents/skills/ebay-price-research/` 下的全部文件
...
python3 .agents/skills/ebay-price-research/scripts/freeze_core.py
